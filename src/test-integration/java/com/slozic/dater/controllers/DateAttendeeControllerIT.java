...
public class DateAttendeeControllerIT extends IntegrationTest {
    ...
    public void getDateAttendees_shouldReturnSuccess() throws Exception {
        ...
        assertThat(mvcResult.getResponse().getContentAsString()).isEqualTo("{\"dateAttendees\":[{\"id\":\"aae884f1-e3bc-4c48-8ebb-adb6f6dfc5d5\",\"username\":\"clara\",\"accepted\":true},{\"id\":\"6c49abd4-0e82-47f6-bb0c-558c9a890bd4\",\"username\":\"tom.h\",\"accepted\":true}]}");
    }
    ...
    public void addAttendeeToDate_shouldReturnSuccess() throws Exception {
        ...
        var mvcResult = mockMvc.perform(
                ...
                .andReturn();
        // then
        DateAttendeeResponse dateAttendeeResponse = dateAttendeesService.getAllDateAttendees(dateId);
        assertThat(dateAttendeeResponse.dateAttendees()).flatMap(DateAttendeeDto::id).contains(userId);
        assertThat(mvcResult.getResponse().getStatus()).isEqualTo(200);
        assertThat(mvcResult.getResponse().getContentAsString()).isEqualTo("User added successfully! Status: ON_WAITLIST");
    }
    ...
    public void addAttendeeToDate_shouldFailWhenDateDoesNotExist() throws Exception {
        ...
        assertThat(mvcResult.getResolvedException().getMessage()).isEqualTo("No date event found: " + dateId);
    }
